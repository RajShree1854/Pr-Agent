...
def show_relevant_configurations(relevant_section: str) -> str:
    ...
    markdown_text +="<br>These are the relevant [configurations](https://github.com/rajshree1854/pr-agent/blob/main/pr_agent/settings/configuration.toml) for this tool:\n\n"
