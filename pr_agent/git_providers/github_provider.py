...
class GithubProvider(GitProvider):
    ...
    # Example: https://github.com/rajshree1854/pr-agent.git and branch: v0.8 -> prefix: "https://github.com/rajshree1854/pr-agent/blob/v0.8", suffix: ""
        ...
        if self.deployment_type == 'app':
            ...
            try:
                ...
                raise ValueError(
                    ...
                    "https://github.com/rajshree1854/pr-agent#method-2-run-from-source") from e
    ...
    def _prepare_clone_url_with_token(self, repo_url_to_clone: str) -> str | None:
        ...
        #https://github.com/rajshree1854/pr-agent-pro.git
        #Need to embed inside the github token:
        #https://<token>@github.com/rajshree1854/pr-agent-pro.git
