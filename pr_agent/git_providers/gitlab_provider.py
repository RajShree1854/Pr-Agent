...
class GitLabProvider(GitProvider):
    ...
    def _prepare_clone_url_with_token(self, repo_url_to_clone: str) -> str | None:
        ...
        # For example: For repo url: https://gitlab.pr-agent-inc.com/qodo/autoscraper.git
        # Then to clone one will issue: 'git clone https://oauth2:<access token>@gitlab.pr-agent-inc.com/qodo/autoscraper.git'
