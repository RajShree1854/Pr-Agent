...
The possible configurations of PR-Agent are stored in [here](https://github.com/rajshree1854/pr-agent/blob/main/pr_agent/settings/configuration.toml){:target="_blank"}.
...
![possible_config1](https://www.codium.ai/images/pr_agent/possible_config1.png){width=512}
...
![possible_config2](https://www.codium.ai/images/pr_agent/possible_config2.png){width=512}
...
[//]: # ()
[//]: # (The default mode of pr-agent is to have a single call per tool, using GPT-4, which has a token limit of 8000 tokens.)
...
You can view the list of auto-generated file patterns in [`generated_code_ignore.toml`](https://github.com/rajshree1854/pr-agent/blob/main/pr_agent/settings/generated_code_ignore.toml).
