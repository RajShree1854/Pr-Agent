...
![notifications](https://pr-agent.ai/images/pr_agent/notifications.png){width=512}
...
![filter_mail_notifications](https://pr-agent.ai/images/pr_agent/filter_mail_notifications.png){width=512}
