...
For other git providers, update `CONFIG__GIT_PROVIDER` accordingly and check the [`pr_agent/settings/.secrets_template.toml`](https://github.com/rajshree1854/pr-agent/blob/main/pr_agent/settings/.secrets_template.toml) file for environment variables expected names and values.
...
def main():
    ...
    pr_url = "..."      # PR URL, for example 'https://github.com/rajshree1854/pr-agent/pull/809'
