...
![Ask Comment](https://pr-agent.ai/images/pr_agent/ask_comment.png){width=512}

![Ask](https://pr-agent.ai/images/pr_agent/ask.png){width=512}
...
![Ask Line](https://pr-agent.ai/images/pr_agent/Ask_line.png){width=512}
...
![Ask image1](https://pr-agent.ai/images/pr_agent/ask_images1.png){width=512}

2\. Quote reply to that comment:

![Ask image2](https://pr-agent.ai/images/pr_agent/ask_images2.png){width=512}

3\. In the screen opened, type the question below the image:

![Ask image3](https://pr-agent.ai/images/pr_agent/ask_images3.png){width=512}
![Ask image4](https://pr-agent.ai/images/pr_agent/ask_images4.png){width=512}

4\. Post the comment, and receive the answer:

![Ask image5](https://pr-agent.ai/images/pr_agent/ask_images5.png){width=512}

See a full video tutorial [here](https://pr-agent.ai/images/pr_agent/ask_image_video.mov)
