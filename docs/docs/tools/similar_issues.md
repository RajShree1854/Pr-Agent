...
- To invoke the 'similar' issue tool via online usage, [comment](https://github.com/rajshree1854/pr-agent/issues/178#issuecomment-1716934893) on a PR:
`/similar_issue`

- You can also enable the 'similar issue' tool to run automatically when a new issue is opened, by adding it to the [pr_commands list in the github_app section](https://github.com/rajshree1854/pr-agent/blob/main/pr_agent/settings/configuration.toml#L229)
