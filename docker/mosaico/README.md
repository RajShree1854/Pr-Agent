...
[`rajshree1854/pr-agent`](https://github.com/rajshree1854/pr-agent), under `pr_agent/mosaico/`;
...
- Canonical source of every file in this bundle is `docker/mosaico/` in
  `github.com/rajshree1854/pr-agent` — this directory. The GitLab deployment mirror holds
...
MIT — see the bundled [`LICENSE`](./LICENSE). `rajshree1854/pr-agent` is MIT-licensed too.
